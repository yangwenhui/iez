...
public class ProjectController {
	...
	public String deleteProject(@RequestParam("id") Long id) {
		...
		Thread t1 = new Thread(new DeleteFile(tempPath));
		t1.start();
		Thread t2 = new Thread(new DeleteFile(topPath));
		t2.start();
